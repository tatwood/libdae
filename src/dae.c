...
static const dae_schemainfo* dae_construct_schema()
{
    ...
    static dae_structinfo structs[226];
    {
    ...
    }
    {
        ...
        elem[7].dae_type = dae_ID_TECHNIQUE_COMMON_SOURCE;
        elem[7].restrict = dae_RESTRICT_OPTIONAL;
    ...
    }
    {
        ...
        elem[0].dae_type = dae_ID_TECHNIQUE_COMMON_OPTICS;
        elem[0].restrict = dae_RESTRICT_REQUIRED;
    ...
    }
    {
        ...
        elem[1].dae_type = dae_ID_TECHNIQUE_COMMON_FORMULA;
        elem[1].restrict = dae_RESTRICT_REQUIRED;
    ...
    {
        dae_structinfo* def = structs + dae_ID_TECHNIQUE_COMMON_FORMULA;
        def->attrs = NULL;
        def->elems = NULL;
        def->datatype = dae_DATA_STRING;
        def->dataoffset = offsetof(dae_technique_common_formula,data);
        def->mindata = 0;
        def->maxdata = 1;
        def->isunion = 0;
        def->numattrs = 0;
        def->numelems = 0;
        def->size = sizeof(dae_technique_common_formula);
    }
    {
    ...
    }
    {
        ...
        elem[0].dae_type = dae_ID_PARAM;
        elem[0].restrict = dae_RESTRICT_LIST;
        elem[0].offset = offsetof(dae_bind_material,param);
        elem[1].name = "technique_common";
        elem[1].dae_type = dae_ID_TECHNIQUE_COMMON_BIND_MATERIAL;
        elem[1].restrict = dae_RESTRICT_REQUIRED;
        elem[1].offset = offsetof(dae_bind_material,technique_common);
        elem[2].name = "technique";
        elem[2].dae_type = dae_ID_TECHNIQUE;
        elem[2].restrict = dae_RESTRICT_LIST;
        elem[2].offset = offsetof(dae_bind_material,technique);
        elem[3].name = "extra";
        elem[3].dae_type = dae_ID_EXTRA;
        elem[3].restrict = dae_RESTRICT_LIST;
        elem[3].offset = offsetof(dae_bind_material,extra);
        def->attrs = NULL;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
    ...
    }
    {
        ...
        elem[1].name = "technique_common";
        elem[1].dae_type = dae_ID_TECHNIQUE_COMMON_LIGHT;
        elem[1].restrict = dae_RESTRICT_REQUIRED;
    ...
    {
        dae_structinfo* def = structs + dae_ID_TECHNIQUE_COMMON_LIGHT;
        static dae_eleminfo elem[4];
        elem[0].name = "ambient";
        elem[0].dae_type = dae_ID_AMBIENT;
        elem[0].restrict = dae_RESTRICT_OPTIONAL;
        elem[0].offset = offsetof(dae_technique_common_light,ambient);
        elem[1].name = "directional";
        elem[1].dae_type = dae_ID_DIRECTIONAL;
        elem[1].restrict = dae_RESTRICT_OPTIONAL;
        elem[1].offset = offsetof(dae_technique_common_light,directional);
        elem[2].name = "point";
        elem[2].dae_type = dae_ID_POINT;
        elem[2].restrict = dae_RESTRICT_OPTIONAL;
        elem[2].offset = offsetof(dae_technique_common_light,point);
        elem[3].name = "spot";
        elem[3].dae_type = dae_ID_SPOT;
        elem[3].restrict = dae_RESTRICT_OPTIONAL;
        elem[3].offset = offsetof(dae_technique_common_light,spot);
        def->attrs = NULL;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 0;
        def->numelems = 4;
        def->size = sizeof(dae_technique_common_light);
    }
    {
    ...
    {
        dae_structinfo* def = structs + dae_ID_TECHNIQUE_COMMON_OPTICS;
        static dae_eleminfo elem[2];
        elem[0].name = "orthographic";
        elem[0].dae_type = dae_ID_ORTHOGRAPHIC;
        elem[0].restrict = dae_RESTRICT_OPTIONAL;
        elem[0].offset = offsetof(dae_technique_common_optics,orthographic);
        elem[1].name = "perspective";
        elem[1].dae_type = dae_ID_PERSPECTIVE;
        elem[1].restrict = dae_RESTRICT_OPTIONAL;
        elem[1].offset = offsetof(dae_technique_common_optics,perspective);
        def->attrs = NULL;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 0;
        def->numelems = 2;
        def->size = sizeof(dae_technique_common_optics);
    }
    {
    ...
    {
        dae_structinfo* def = structs + dae_ID_TECHNIQUE_COMMON_SOURCE;
        static dae_eleminfo elem[1];
        elem[0].name = "accessor";
        elem[0].dae_type = dae_ID_ACCESSOR;
        elem[0].restrict = dae_RESTRICT_REQUIRED;
        elem[0].offset = offsetof(dae_technique_common_source,accessor);
        def->attrs = NULL;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 0;
        def->numelems = 1;
        def->size = sizeof(dae_technique_common_source);
    }
    {
    ...
    {
        dae_structinfo* def = structs + dae_ID_TECHNIQUE_COMMON_BIND_MATERIAL;
        static dae_eleminfo elem[1];
        elem[0].name = "instance_material";
        elem[0].dae_type = dae_ID_INSTANCE_MATERIAL_GEOMETRY;
        elem[0].restrict = dae_RESTRICT_LIST;
        elem[0].offset = offsetof(dae_technique_common_bind_material,instance_material);
        def->attrs = NULL;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 0;
        def->numelems = 1;
        def->size = sizeof(dae_technique_common_bind_material);
    }
    {
        dae_structinfo* def = structs + dae_ID_INSTANCE_MATERIAL_GEOMETRY;
        static dae_attrinfo attr[4];
        static dae_eleminfo elem[3];
        attr[0].name = "sid";
        attr[0].offset = offsetof(dae_instance_material_geometry,sid);
        attr[0].datatype = dae_DATA_STRING;
        attr[0].defaultval.string_val = NULL;
        attr[1].name = "name";
        attr[1].offset = offsetof(dae_instance_material_geometry,name);
        attr[1].datatype = dae_DATA_STRING;
        attr[1].defaultval.string_val = NULL;
        attr[2].name = "target";
        attr[2].offset = offsetof(dae_instance_material_geometry,target);
        attr[2].datatype = dae_DATA_STRING;
        attr[2].defaultval.string_val = NULL;
        attr[3].name = "symbol";
        attr[3].offset = offsetof(dae_instance_material_geometry,symbol);
        attr[3].datatype = dae_DATA_STRING;
        attr[3].defaultval.string_val = NULL;
        elem[0].name = "bind";
        elem[0].dae_type = dae_ID_BIND_FX;
        elem[0].restrict = dae_RESTRICT_LIST;
        elem[0].offset = offsetof(dae_instance_material_geometry,bind);
        elem[1].name = "bind_vertex_input";
        elem[1].dae_type = dae_ID_BIND_VERTEX_INPUT;
        elem[1].restrict = dae_RESTRICT_LIST;
        elem[1].offset = offsetof(dae_instance_material_geometry,bind_vertex_input);
        elem[2].name = "extra";
        elem[2].dae_type = dae_ID_EXTRA;
        elem[2].restrict = dae_RESTRICT_LIST;
        elem[2].offset = offsetof(dae_instance_material_geometry,extra);
        def->attrs = attr;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 4;
        def->numelems = 3;
        def->size = sizeof(dae_instance_material_geometry);
    }
    {
    ...
    }
    {
        ...
        elem[2].name = "texture";
        elem[2].dae_type = dae_ID_TEXTURE_FX;
        elem[2].restrict = dae_RESTRICT_OPTIONAL;
    ...
    {
        dae_structinfo* def = structs + dae_ID_TEXTURE_FX;
        static dae_attrinfo attr[2];
        static dae_eleminfo elem[1];
        attr[0].name = "texture";
        attr[0].offset = offsetof(dae_texture_fx,texture);
        attr[0].datatype = dae_DATA_STRING;
        attr[0].defaultval.string_val = NULL;
        attr[1].name = "texcoord";
        attr[1].offset = offsetof(dae_texture_fx,texcoord);
        attr[1].datatype = dae_DATA_STRING;
        attr[1].defaultval.string_val = NULL;
        elem[0].name = "extra";
        elem[0].dae_type = dae_ID_EXTRA;
        elem[0].restrict = dae_RESTRICT_LIST;
        elem[0].offset = offsetof(dae_texture_fx,extra);
        def->attrs = attr;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 2;
        def->numelems = 1;
        def->size = sizeof(dae_texture_fx);
    }
    {
    ...
    }
    {
        ...
        static dae_eleminfo elem[5];
        attr[0].name = "id";
        attr[0].offset = offsetof(dae_effect,id);
        attr[0].datatype = dae_DATA_STRING;
        attr[0].defaultval.string_val = NULL;
        attr[1].name = "name";
        attr[1].offset = offsetof(dae_effect,name);
        attr[1].datatype = dae_DATA_STRING;
        attr[1].defaultval.string_val = NULL;
        elem[0].name = "asset";
        elem[0].dae_type = dae_ID_ASSET;
    ...
    }
    {
        ...
        elem[2].name = "technique";
        elem[2].dae_type = dae_ID_TECHNIQUE_FX;
        elem[2].restrict = dae_RESTRICT_REQUIRED;
    ...
    {
        dae_structinfo* def = structs + dae_ID_BIND_FX;
        def->attrs = NULL;
        def->elems = NULL;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 0;
        def->numelems = 0;
        def->size = sizeof(dae_bind_fx);
    }
    {
        dae_structinfo* def = structs + dae_ID_BIND_VERTEX_INPUT;
        def->attrs = NULL;
        def->elems = NULL;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 0;
        def->numelems = 0;
        def->size = sizeof(dae_bind_vertex_input);
    }
    {
    ...
    {
        dae_structinfo* def = structs + dae_ID_TECHNIQUE_FX;
        static dae_eleminfo elem[5];
        elem[0].name = "asset";
        elem[0].dae_type = dae_ID_ASSET;
        elem[0].restrict = dae_RESTRICT_OPTIONAL;
        elem[0].offset = offsetof(dae_technique_fx,asset);
        elem[1].name = "constant";
        elem[1].dae_type = dae_ID_CONSTANT;
        elem[1].restrict = dae_RESTRICT_OPTIONAL;
        elem[1].offset = offsetof(dae_technique_fx,constant);
        elem[2].name = "lambert";
        elem[2].dae_type = dae_ID_LAMBERT;
        elem[2].restrict = dae_RESTRICT_OPTIONAL;
        elem[2].offset = offsetof(dae_technique_fx,lambert);
        elem[3].name = "phong";
        elem[3].dae_type = dae_ID_PHONG;
        elem[3].restrict = dae_RESTRICT_OPTIONAL;
        elem[3].offset = offsetof(dae_technique_fx,phong);
        elem[4].name = "blinn";
        elem[4].dae_type = dae_ID_BLINN;
        elem[4].restrict = dae_RESTRICT_OPTIONAL;
        elem[4].offset = offsetof(dae_technique_fx,blinn);
        def->attrs = NULL;
        def->elems = elem;
        def->datatype = dae_DATA_NONE;
        def->dataoffset = -1;
        ...
        def->numattrs = 0;
        def->numelems = 5;
        def->size = sizeof(dae_technique_fx);
    }
